...
/**
 * Admin error boundary — catches errors in the /org/[slug]/admin segment
 * and the legacy /admin redirect.
 */
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4 text-center">
          <p className="text-sm text-muted-foreground">
            The admin panel encountered an error. Try reloading the page.
          </p>
          {error?.message && (
