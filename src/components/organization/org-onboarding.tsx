                  ...
                  >
                    <div className="space-y-3">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          signIn("google", { callbackUrl: "/org-register" }).catch(() => {
                    ...
                    <div className="text-center text-xs text-slate-500 dark:text-slate-400">
                      ...
                      <button type="button" onClick={() => { window.location.href = "/register" }} className="font-medium text-emerald-600 hover:underline dark:text-emerald-400">
                        Register here
                      </button>
                    </div>
