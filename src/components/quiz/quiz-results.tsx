...
function buildReportPng(input: {
  ...
  // Header: Event name (BIG) + "Result Report" subtitle
  ctx.fillStyle = "#064e3b"
  ctx.font = "bold 28px sans-serif"
  ctx.textAlign = "center"
  const eventTitleShort = truncateText(ctx, input.eventTitle, W - 160)
  ctx.fillText(eventTitleShort, W / 2, 110)
  ...
  // Participant name (directly below header, no "EVENT" label needed)
  ctx.fillStyle = "#6b7280"
  ctx.font = "12px sans-serif"
  ctx.fillText("PARTICIPANT", W / 2, 190)
  ctx.fillStyle = "#0f172a"
  ctx.font = "bold 20px sans-serif"
  ctx.fillText(truncateText(ctx, input.studentName, W - 160), W / 2, 218)
